		...
		<div class="row">
			...
			<div id="content" class="col-md-9 col-sm-8">
				<div class="products-category">
					...
					<div class="product-filter product-filter-top filters-panel"></div>
										...
										<div class="product-item-container">
											<div class="left-block left-b">
												...
												<div class="product-image-container second_img">
													<a href="product/${commodity.rowId}" id="goProductId"  target="_self" title="Lastrami bacon"> <img src="${commodity.commodityPhoto}" class="img-1 img-responsive" style="height: 200px; width: 200px;" alt="image1"> <img src="${commodity.commodityPhoto}" class="img-2 img-responsive" style="height: 200px; width: 200px;" alt="image2">
													</a>
												</div>
											</div>
...
<script type="text/javascript">
	$(document).ready(function() {
		$(document).off('click','#btn-add-cart-id').on('click','#btn-add-cart-id', function() {
