				...
				<div class="module newsletter-footer1">
					<div class="newsletter">
						...
						<div class="title-block">
							<div class="page-heading font-title">Signup for Newsletter</div>
						...
						<div class="block_content">
							<form method="post" id="signup" name="signup" class="form-group form-inline signup send-mail">
								<div class="form-group">
									...
									<div class="subcribe">
										<button class="btn btn-primary btn-default font-title" type="submit" onclick="return subscribe_newsletter();" name="submit">Subscribe</button>
									</div>
								</div>
							</form>
				...
				<div class="col-lg-2 col-md-4 col-sm-4 col-xs-12 col-infos">
					<div class="infos-footer">
						...
						<ul class="menu">
							...
							<li class="mail"><a href="mailto:contact@opencartworks.com">contact@opencartworks.com</a></li>
